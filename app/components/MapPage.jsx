...
export default function MapPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && !mapRef.current) {
      const map = L.map("map-container").setView(defaultPosition, 22);
  ...
  return (
    <div className="overflow-y-hidden relative">
      <header className="w-full flex flex-col items-center justify-center h-[20vh]">
      ...
      <div className="h-[80vh]" id="step1">
        ...
        />
        <div className="flex justify-between absolute bottom-10 px-10 z-10 w-full">
